class Model(object):
    ...
    def train_on_batch(self, sess, inputs_batch, labels_batch, summarize):
    ...
    def predict_on_batch(self, sess, inputs_batch, summarize):
    ...
    def build(self, summarize=False):
        self.add_placeholders()
        self.pred = self.add_prediction_op()
        self.loss = self.add_loss_op(self.pred)
        self.train_op = self.add_training_op(self.loss)
        if summarize:
            self.summary = self.add_summary_op(self.pred, self.loss)
